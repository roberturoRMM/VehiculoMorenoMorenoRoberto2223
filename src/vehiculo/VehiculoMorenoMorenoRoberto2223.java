 ...
 */
public class VehiculoMorenoMorenoRoberto2223 {
    ...
    public VehiculoMorenoMorenoRoberto2223 ()
    {
    }
    // Constructor con parámetro para iniciar todas las propiedades de la clase
    
    
    public VehiculoMorenoMorenoRoberto2223 (String nom, double precio, int stock)
    {
        this.nombre =nom;
        this.precio=precio;
        this.stock=stock;
